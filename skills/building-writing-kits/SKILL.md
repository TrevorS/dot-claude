...
Before calling a claim wrong, check every source that carries the fact, not only the kit's citation. Two sources that word it differently is a conflict to report, not an error in the doc. Say nothing about style or voice unless asked.
...
Fixed pattern per section, so it is learned once and skimmed. Two to four times the target length. The usual overshoot is the ledger copied in whole instead of filtered by each section's question. A section holds the facts its question needs, usually under ten; a fact no question needs becomes a pointer under Links. Past four times, the person is searching again.
...
Questions rather than headings, so the person can change the shape and still know what coverage they owe. Objections nothing answers stay in; they say what the person will be asked and cannot yet defend, and each also goes in "Only you know".
