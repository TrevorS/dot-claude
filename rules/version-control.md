...
- Always pass `-m` to `describe`, `commit`, `new`, `squash`; without it jj opens an editor and the session blocks. A hook rejects the editor-opening forms and prints the fix.
